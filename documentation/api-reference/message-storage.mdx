...
<Steps>
  <Step title="Recebimento" icon="inbox">
    Mensagem chega via WhatsApp e é capturada pelo handler.
  </Step>
  <Step title="Indexação" icon="list">
    Dados são estruturados em JSON com metadados do contato e conteúdo.
  </Step>
  <Step title="Compressão" icon="file-zipper">
    JSON é compactado com gzip antes de qualquer gravação em disco.
  </Step>
  <Step title="Armazenamento" icon="floppy-disk">
    Arquivo compactado é salvo no disco, ocupando até 70% menos espaço.
  </Step>
  <Step title="Leitura" icon="magnifying-glass">
    Ao buscar, o arquivo é descompactado em memória, processado e retornado via API.
  </Step>
</Steps>
...
| Quantidade de Mensagens | Espaço Ocupado |
| :--- | :--- |
