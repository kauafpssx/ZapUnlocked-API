...
## <img src="https://github.com/lipis/flag-icons/raw/refs/heads/main/flags/4x3/fr.svg" width="30"> Qu'est-ce que ZapUnlocked-API ?
...
### Événements Disponibles (20 types)

| Événement | Description |
| :-------- | :---------- |
| `message.text` | Texte simple / formaté |
| `message.image` | Image reçue |
| `message.video` | Vidéo reçue |
| `message.audio` | Audio / note vocale |
| `message.document` | Document / fichier |
| `message.sticker` | Sticker |
| `message.contact` | Contact partagé |
| `message.location` | Localisation |
| `message.reaction` | Réaction (emoji) |
| `message.poll_created` | Sondage reçu |
| `message.poll_vote` | Vote dans un sondage |
| `message.button_reply` | Clic sur bouton |
| `message.list_reply` | Sélection dans liste interactive |
| `message.deleted` | Message supprimé par l'expéditeur |
| `message.unknown` | Type de message non mappé |
| `message.sent` | Message envoyé (manuel) |
| `connection.connected` | WhatsApp connecté |
| `connection.disconnected` | WhatsApp déconnecté |
| `connection.qr_ready` | Code QR généré |
| `call.received` | Appel reçu |
...
<details>
<summary><b>📦 Exemples de Payload par Événement</b></summary>
...
```mermaid
flowchart LR
  A[Cloner] --> B[Installer]
  B --> C[Configurer .env]
  C --> D[Lancer 🚀]
  D --> E[Configurer Compte 🔗]
  E --> F[Production ⚡]
```
...
| Projet | Description |
| :----- | :---------- |
| [![Neonize](https://img.shields.io/badge/Neonize-A855F7?style=for-the-badge&logo=python&logoColor=white)](https://github.com/krypton-byte/neonize) | Bibliothèque Python pour connexion native WhatsApp Web |
| [![whatsmeow](https://img.shields.io/badge/whatsmeow-A855F7?style=for-the-badge&logo=go&logoColor=white)](https://github.com/tulir/whatsmeow) | Bibliothèque Go de base de Neonize · le coeur de la connexion |
| [![Alwaysdata](https://img.shields.io/badge/Alwaysdata-A855F7?style=for-the-badge&logo=alwaysdata&logoColor=white)](https://www.alwaysdata.com/) | Infrastructure gratuite de haute qualité |
