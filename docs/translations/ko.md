...
> [!TIP]
> 봇 통합, 알림 및 자동화ëœ 고객 서비스 시스템을 구축하는 개발자에게 적합합니다. **비용 부담 없이.**
...
| 기능 | 설명 |
| :--- | :---- |
| 🧩 **상태 없는 버튼** | 암호화ëœ 웹훅으로 데이터베이스 없이 대화형 흐름 생성 |
...
| `POST` | `/messages/edit` | 전송ëœ 메시지 편집 | `phone`, `messageId`, `message` |
</details>
...
webhook에 `{{placeholders}}`가 포함ëœ 커스텀 `body`가 있는 경우, 표준 봉투 대신 해당 body가 전송됩니다.
...
<details>
<summary><code>message.text</code> - 일반 / 포맷ëœ 텍스트</summary>
...
<details>
<summary><code>message.image</code> - 수신ëœ 이미지</summary>
...
<details>
<summary><code>message.video</code> - 수신ëœ 비디오</summary>
...
<details>
<summary><code>message.contact</code> - 공유ëœ 연락처</summary>
...
<details>
<summary><code>message.poll_created</code> - 수신ëœ 투표</summary>
...
<details>
<summary><code>message.sent</code> - 전송ëœ 메시지 (수동)</summary>
...
<details>
<summary><code>message.delivered</code> - 수신자에게 전달ëœ 메시지 (receipt type 1)</summary>
