...
## <img src="https://github.com/lipis/flag-icons/raw/refs/heads/main/flags/4x3/de.svg" width="30"> Was ist ZapUnlocked-API?
...
mindmap
  root((📲 ZapUnlocked-API))
    📨 Nachrichten
      ...
      Reaktionen / Standort
      Kontakte / Links
      Bearbeiten / Löschen / Lesen
    🔘 Interaktiv
      Zustandslose Buttons
      Optionsliste
      Umfragen
    🔍 Abfragen
      Kontaktinfo
...
<details>
<summary><b>📨 Nachrichten senden</b> · 14 Endpunkte</summary>
...
| `POST` | `/settings/block` | Kontakt sperren / entsperren |
</details>

<details>
<summary><b>🤖 Bot-Konfiguration</b> · 5 Endpunkte</summary>
...
> **Insgesamt: 56 Endpunkte** · Vollständige REST-API für WhatsApp-Automatisierung.
...
```mermaid
flowchart LR
  A[Klonen] --> B[Installieren]
  B --> C[.env konfigurieren]
  C --> D[Starten 🚀]
  D --> E[Konto verbinden 🔗]
  E --> F[Produktion ⚡]
```
...
| :------ | :----------- |
| [![Neonize](https://img.shields.io/badge/Neonize-A855F7?style=for-the-badge&logo=python&logoColor=white)](https://github.com/krypton-byte/neonize) | Python-Bibliothek für native WhatsApp Web-Verbindung |
| [![whatsmeow](https://img.shields.io/badge/whatsmeow-A855F7?style=for-the-badge&logo=go&logoColor=white)](https://github.com/tulir/whatsmeow) | Go-Basisbibliothek von Neonize · das Herz der Verbindung |
| [![Alwaysdata](https://img.shields.io/badge/Alwaysdata-A855F7?style=for-the-badge&logo=alwaysdata&logoColor=white)](https://www.alwaysdata.com/) | Hochwertige kostenlose Infrastruktur |
